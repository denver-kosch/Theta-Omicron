...
import type { CommitteePositionProps, CommitteePositionType } from "@/types";

type CommitteeComponent = LazyExoticComponent<ComponentType>;

const committeeMap: Record<string, Record<string, CommitteeComponent>> = {
    'Bylaws Committee': {
...
const CommitteePosition = ({position}: CommitteePositionProps) => {
...
export const allPositions: CommitteePositionType[] = Object.entries(committeeMap).flatMap(([committeeName, roles]) =>
